...
function getRewardMessage(total) {
  if (total >= 140) {
    return "🎁 Récompense débloquée : sortie voiture + manger 🚗🍴 / sortie plage, restau et activité nautique 🌊💖 / hôtel ❤️";
  }
  ...
  return "💗 Pas encore de récompense débloquée. Il faut atteindre au moins 100 points.";
}
